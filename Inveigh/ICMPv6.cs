    ...
    class ICMPv6
    {
        public static void icmpv6RouterAdvertise(string ipV6, int interval)
        {
            ...
            while (!Program.exitInveigh)
            {
                ...
                {
                    ms.Write((new byte[16] { 0x86, 0x00, 0x00, 0x00, 0x00, 0xc8, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }), 0, 16);
                    byte[] pseudoHeader = Util.GetIPv6PseudoHeader(IPAddress.Parse("ff02::1"), IPAddress.Parse(ipV6), 58, (int)ms.Length);
                    ...
                    icmpv6SendSocket.SendTo(ms.ToArray(), 16, SocketFlags.None, icmpv6EndPoint);
